...
public class Interpreter extends Activity {
	...
	/*added*/
        ...
        compassNorth.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                boolean semaphore = true; // GOAL: disable input after button clicked and before enter-signal send in order not to lose data
                while (semaphore) {
                    glk.setNorth(true);
	...
	/*/added*/
        glk.start();
        if (PreferenceManager.getDefaultSharedPreferences(this).getBoolean("enableCompass", true)) {//gets the value of the box
            compassNorth.setVisibility(View.VISIBLE);
            compassEast.setVisibility(View.VISIBLE);
            compassSouth.setVisibility(View.VISIBLE);
            compassWest.setVisibility(View.VISIBLE);
        } else {
            compassNorth.setVisibility(View.INVISIBLE);
            compassEast.setVisibility(View.INVISIBLE);
            compassSouth.setVisibility(View.INVISIBLE);
            compassWest.setVisibility(View.INVISIBLE);
        }
    }
